...
export default function ClientReview({ autoplay = true, interval = 4000 }) {
  ...
  const scrollByOne = (behavior = "smooth") => {
    const el = containerRef.current;
    if (!el) return;
    const cw = cardWidth();
    if (!cw) return;
  ...
  }, [autoplay, interval, paused, visibleCount]);
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="text-center">
          ...
          <p className="mt-2 text-base text-gray-600">Real feedback from users who rely on these tools every day.</p>
        </div>
