...
import * as downloadYoutubeModule from './download-youtube.js';
...
export const downloadYoutubeProcessor = downloadYoutubeModule;
...
const registry = {
  ...
  'download-youtube': downloadYoutubeProcessor,
};
...
// import { pdfToWord, compressPdf } from '@/lib/tools'
export const compressPdf = compressPdfProcessor;
export const rotatePdf = rotatePdfProcessor;
export const downloadYoutube = downloadYoutubeProcessor;
